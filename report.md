...
3.Existing Acom subscriber only have 3% of chance to become Xseller. For this part I am not sure what does this mean. One assumption is that they are already Acom subscriber and there is no point to do cross well. The other assumption is that they are former Acom subscribers and Ancestry wants them to keep using this product so they do cross sell campaign on them as well. But it seems a lot of them are not interested in continuing the subscriptions. So the marketing and product team might think of ways to improve the retention rate of the existing subscribers

4. The faster a user activates their test the more likely they will convert to Xseller. After users place DNA orders, we can remind them to activate their tests as soon as possible and educate them on what are the benefits of the tests. Assuming missing test date means no activation, about 75k users do not activate their test and lose the chance to experience Ancestry DNA product. They might forget or not sure what to do to activate the test and we want to eliminate these cases.
